    ...
    <section className="relative z-10 px-6 py-16 text-center">
      <div className="max-w-4xl mx-auto fade-in">
        ...
        <p className="text-xl md:text-2xl text-teal-100/80 mb-8 max-w-2xl mx-auto">
          Monitor energy systems with AI-powered insights, automated reporting,
          and comprehensive data exports.
        </p>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-teal-100/70 text-lg max-w-2xl mx-auto">
            Comprehensive monitoring with AI-powered analytics and data export
            capabilities.
          </p>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-emerald-900 text-white overflow-x-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        ></div>
        <div
          className="absolute top-1/3 right-1/4 w-20 h-20 rounded-full bg-cyan-300/5 float"
          style={{ animationDelay: "-1s" }}
        ></div>
        <div
          className="absolute bottom-1/4 left-1/3 w-28 h-28 rounded-full bg-purple-400/5 float"
